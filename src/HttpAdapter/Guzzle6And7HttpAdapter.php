...
final class Guzzle6And7HttpAdapter implements HttpAdapterInterface
{
    /**
    ...
    private function parseResponseBody(ResponseInterface $response)
    {
        ...
        if (json_last_error() !== JSON_ERROR_NONE) {
            throw new ApiException("Unable to decode API response: '{$body}'.");
        }
    ...
    /**
     * The version number for the underlying http client, if available. This is used to report the UserAgent to the API,
