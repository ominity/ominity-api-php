...
class CustomerOrderEndpoint extends CollectionEndpointAbstract
{
    /**
     * @var string
     */
    ...
    /**
     * Create a new order for a specific Customer ID.
     *
     ...
     * @throws \Ominity\Api\Exceptions\ApiException
     */
    public function getFor(Customer $customer, int $orderId, array $parameters = []) {
        if (empty($customer)) {
        ...
        return $this->getForId($customer->id, $orderId, $parameters);
    }

    /**
     * Get the order for a specific Customer ID.
     *
     * @param int $customerId
     * @param int $orderId
     * @return Order
     ...
     * @throws \Ominity\Api\Exceptions\ApiException
     */
    public function getForId(int $customerId, int $orderId, array $parameters = []) {
        if (empty($customerId)) {
    ...
    /**
     * Retrieves a collection of orders for a specific Customer.
     *
     * @param Customer $customer
    ...
    public function pageFor(Customer $customer, $page = null, $limit = null, array $parameters = [])
    {
     ...
     /**
     * Retrieves a collection of orders for a specific Customer ID.
     *
     * @param int $customerId
     * @param int $page The page number to request
     * @param int $limit
    ...
    /**
     * Create an iterator for iterating over orders for the given customer retrieved from Ominity.
     *
     * @param Customer $customer
     * @param array $parameters
    ...
    /**
     * Create an iterator for iterating over orders for the given customer id retrieved from Ominity.
     *
     * @param int $customerId
     * @param array $parameters
     * @param bool $iterateBackwards Set to true for reverse order iteration (default is false).
