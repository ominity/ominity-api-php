...
use Ominity\Api\Resources\Modules\Knowledgebase\Tag;
use Ominity\Api\Resources\Modules\Knowledgebase\TagCollection;

class TagEndpoint extends CollectionEndpointAbstract
{
    protected $resourcePath = "modules/knowledgebase/tags";
    ...
    /**
     * Retrieve an knowledge base Tag from the API.
     *
    ...
    /**
     * Retrieves a collection of knowledge base Tags from the API.
     *
