...
use Ominity\Api\Resources\Modules\Blog\Post;
use Ominity\Api\Resources\Modules\Blog\PostCollection;

class PostEndpoint extends CollectionEndpointAbstract
{
    protected $resourcePath = "modules/blog/posts";
    ...
    {
        return new PostCollection($this->client, $count, $_links);
    }

    /**
     * Retrieve an blog Post from the API.
     *
     * Will throw a ApiException if the post id is invalid or the resource cannot be found.
     *
     * @param int $postId
     ...
     * @throws ApiException
     */
    public function get($postId, array $parameters = [])
    {
        return $this->rest_read($postId, $parameters);
    }

    /**
     * Retrieves a collection of blog Posts from the API.
     *
