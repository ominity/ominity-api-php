...
class CategoryEndpoint extends CollectionEndpointAbstract
{
    ...
    /**
     * Retrieve an blog Category from the API.
     *
    ...
    /**
     * Retrieves a collection of blog Categories from the API.
     *
